...
|   8.1.14   |           4.5.2, 4.5.0            |
+------------+-----------------------------------+
|   8.1.15   | 5.3.0, 5.2.0, 5.1.0, 5.0.2, 5.0.0 |
+------------+-----------------------------------+
|   8.1.16   | 5.3.0, 5.2.0, 5.1.0, 5.0.2, 5.0.0 |
+------------+-----------------------------------+
|   8.1.17   | 5.3.0, 5.2.0, 5.1.0, 5.0.2, 5.0.0 |
+------------+-----------------------------------+
|   8.1.18   | 5.3.0, 5.2.0, 5.1.0, 5.0.2, 5.0.0 |
+------------+-----------------------------------+
|   8.1.19   | 5.3.0, 5.2.0, 5.1.0, 5.0.2, 5.0.0 |
+------------+-----------------------------------+
|   8.1.21   | 5.3.0, 5.2.0, 5.1.0, 5.0.2, 5.0.0 |
+------------+-----------------------------------+
 ...
 * Core specialization will be enabled: as a result, system processes will be constrained to core 0 on every node.
 * The default Slurm ``--core-spec`` or ``-S`` value will be set to 8: This will provide a symmetric distribution of cores per GCD to the application. Post outage, the default number of cores available to each GCD on a node will be 7. To change from the new default value, you can set ``--core-spec`` or ``-S`` in your job submission.
