...
2026-02-10
----------
On Tuesday, February 10, 2026, Frontier's system software were upgraded.
...
- CCE/20.0.2 was made available as non-default via the ``cce/20.0.2`` module. This is compatible with the the CPE/25.09 release of the HPE/Cray Programming Environment. CCE/20.0.0 remains the default compiler for CPE/25.09.
